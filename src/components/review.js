  ...
  <section className="review flex flex--jc--center flex--center flex--wrap pt-20">
    <div className="content">
      <div className="flex flex--center w--100 h--100">
        <div className="flex flex--col pl-12 w--50 text">
          <div className="type type--xxl type--lh-1 type--color--primary type--wgt--bold mb-5">
            See what our users have to say about our app.
          </div>
          {/* <div className="type type--md type--lh-15 type--color--tertiary  mb-5">
            Lorem Ipsum Dolor Sit Amet, Sed Diam Nonumy Eirmod Tempo Lorem Ipsum
          ...
          <div className="review">
            <div className="user flex flex--center">
              ...
              <div className="flex pl-6 flex--col flex--jc--center">
                <div className="type type--md type--wgt--bold">Mark Finney</div>
            ...
            <div className="type type--md type--lh-15 type--color--tertiary  mb-5">
              AvanTourist helped me discover some amazing new places that I
              never would have found on my own. I can't wait to use it on my
              next trip!
            </div>
          </div>
        </div>
      ...
      <div className="download flex flex--center w--100 h--100 mt-20 p-12">
        <div className="flex flex--col pr-12 w--50">
          <div className="type type--xxl type--lh-1 type--color--white type--wgt--bold mb-5">
            Join the AvanTourist movement
          </div>
