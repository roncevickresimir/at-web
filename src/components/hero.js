  ...
  <section className="hero">
    <div className="content">
      <div className="hero--text">
        <div className="type type--huge type--lh-1 type--color--primary type--wgt--bold mb-5">
          Discover, explore and win.
        </div>
        <div className="type type--md type--lh-2 type--color--tertiary  mb-5">
          Welcome to AvanTourist, the ultimate travel app for adventure-seekers
          and explorers.
        </div>
        <div className="flex w--100 mt-3">
          <div className="btn btn--primary mr-3 pl-8 pr-8 pt-3 pb-3">
            Get on AppStore
          </div>
          <div className="btn btn--ghost pl-8 pr-8 pt-3 pb-3">
            Get on PlayStore
          </div>
        </div>
      </div>
      ...
      <img
        className="hero--image image-big"
        src={hero_big}
        alt="tourist explorer"
      />
    </div>
  </section>
)
